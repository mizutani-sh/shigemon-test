...
%load('./foreman',num2str(level),'(fovea)_result/ydct_frame_qp_LL50_gop_1.mat');
%load('./foreman',num2str(level),'(fovea)_result/ydct_frame_qp_LH50_gop_1.mat');
%load('./foreman',num2str(level),'(fovea)_result/ydct_frame_qp_HL50_gop_1.mat');
%load('./foreman',num2str(level),'(fovea)_result/ydct_frame_qp_HH50_gop_1.mat');

LL_load = [strcat('.\foreman',num2str(level),'(fovea)_result\ydct_frame_qp_LL50_gop_1.mat')];
LH_load = [strcat('.\foreman',num2str(level),'(fovea)_result\ydct_frame_qp_LH50_gop_1.mat')];
HL_load = [strcat('.\foreman',num2str(level),'(fovea)_result\ydct_frame_qp_HL50_gop_1.mat')];
HH_load = [strcat('.\foreman',num2str(level),'(fovea)_result\ydct_frame_qp_HH50_gop_1.mat')];
load(LL_load);
load(LH_load);
load(HL_load);
load(HH_load);
...
peaksnr = psnr((uint8(Decoded)), (uint8(Original)));