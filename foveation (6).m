...
LL_load = [strcat('.\football2_result\ydct_frame_qp_LL50_gop_1.mat')];
LH_load = [strcat('.\football2_result\ydct_frame_qp_LH50_gop_1.mat')];
HL_load = [strcat('.\football2_result\ydct_frame_qp_HL50_gop_1.mat')];
HH_load = [strcat('.\football2_result\ydct_frame_qp_HH50_gop_1.mat')];
...
Digital = load('football2_result/ycameras_qp_50_gop_1.mat');
