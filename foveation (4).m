...
load('./foreman2_result/ydct_frame_qp_LL50_gop_1.mat');
load('./foreman2_result/ydct_frame_qp_LH50_gop_1.mat');
load('./foreman2_result/ydct_frame_qp_HL50_gop_1.mat');
load('./foreman2_result/ydct_frame_qp_HH50_gop_1.mat');
...
Decoded2 = Digital.Y_Camera(:,:,1) + Orig(:,:,1);
